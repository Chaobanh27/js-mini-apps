...
//gọi hàm khi trang web được tải xong để cập nhật thông tin và trạng thái phát nhạc ban đầu
window.onload = () => {
...
//1p thì có 60s vì thế phải lấy tổng số giây của một bài chia cho 60 kết quả sẽ là số phút còn phần dư sẽ là số giây
...
const playingSong = () => {
  //allLiTag là 1 mảng chứa các phần tử li
  const allLiTag = ulTag.querySelectorAll("li")
  //console.log(allLiTag.length)
